          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="/blogs" :active="request()->is('blogs')  || request()->is('blogs/*')" >Blogs</x-nav-link>
                <x-nav-link href="/about" :active="request()->is('about')" :button="true">About</x-nav-link>
            ...
            <div class="ml-4 flex items-center md:ml-6">
              ...
              @auth
                ...
                <form action="/logout" method="POST">
                  @csrf
                  <x-form.from-button>Logout</x-form.from-button>
                </form>
              @endauth
            </div>
          </div>
